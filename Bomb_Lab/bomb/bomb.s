...
0000000000400ee0 <phase_1>:
  ...
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi                  # second argument (correct string)  x/s 0x402400
...
0000000000400efc <phase_2>:
  ...
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                     # check if the first number is 1
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax
  400f1a:	01 c0                	add    %eax,%eax                       # geometric sequence, multiply by 2
  400f1c:	39 03                	cmp    %eax,(%rbx)
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx
  400f29:	48 39 eb             	cmp    %rbp,%rbx                       # check if pointer has reached the end
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx                  # fourth argument
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx                  # third argument
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi                  # second argument (format string address)
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>    # first argument is the input string
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>           # input must have at least two values
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>           # first value must be in range 0-7
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)              # if input is 1, jmp to 400fb9
  ...
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>           # if first input is 1, second must be 0x137 = 311 decimal
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax                       # move third argument (upper bound) into eax
  400fd4:	29 f0                	sub    %esi,%eax                       # upper bound minus lower bound
  400fd6:	89 c1                	mov    %eax,%ecx
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx                      # logical right shift 31 bits to extract sign bit
  400fdb:	01 c8                	add    %ecx,%eax                       # (upper - lower) + sign bit
  400fdd:	d1 f8                	sar    %eax                            # ((upper - lower) + sign bit) / 2 = midpoint
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx              # midpoint + lower bound = median
  400fe2:	39 f9                	cmp    %edi,%ecx
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx                 # if first arg < median, upper bound becomes median - 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax                       # if first arg >= median
  400ff7:	39 f9                	cmp    %edi,%ecx
  400ff9:	7d 0c                	jge    401007 <func4+0x39>
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi                  # if first arg > median, lower bound becomes median + 1
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx                   # fourth argument — passed to sscanf to store second input value
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx                   # third argument — passed to sscanf to store first input value
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi                   # second argument (format string address) — sscanf format string
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax
  40102c:	75 07                	jne    401035 <phase_4+0x29>            # requires exactly two input values
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)
  401033:	76 05                	jbe    40103a <phase_4+0x2e>            # first value must be in range 0-14
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                        # third argument: 14 — passed to func4
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                        # second argument: 0 — passed to func4
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi                   # first argument (first input value) — passed to func4
  401048:	e8 81 ff ff ff       	callq  400fce <func4>
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c>            # func4 must return 0
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)                   # second input value must be 0
...
0000000000401062 <phase_5>:
  ...
  401082:	74 4e                	je     4010d2 <phase_5+0x70>            # input string length must be 6
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx               # read each character of the input string
  40108f:	88 0c 24             	mov    %cl,(%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx
  401096:	83 e2 0f             	and    $0xf,%edx                        # mask: take low 4 bits as index offset
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx              # use index to fetch character from table at 0x4024b0: maduiersnfotvbyl
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi                   # maps to "flyers" via table above (indices 0x9 0xf 0xe 0x5 0x6 0x7) — use low 4 bits of ASCII value
...
00000000004010f4 <phase_6>:
  ...
  401121:	76 05                	jbe    401128 <phase_6+0x34>            # input values must be in range 1-6
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>            # jump after all 6 input values are checked
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51>            # input values must all be distinct
  ...
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi                  # end address
  401158:	4c 89 f0             	mov    %r14,%rax                        # start address
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                        # subtract value: 7
  401160:	89 ca                	mov    %ecx,%edx
  401162:	2b 10                	sub    (%rax),%edx                      # 7 - each input value
  401164:	89 10                	mov    %edx,(%rax)                      # store back to corresponding position
  401166:	48 83 c0 04          	add    $0x4,%rax
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx                   # get next linked list node
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx                   # 0x14c 0xa8 0x39c 0x2b3 0x1dd 0x1bb  3 > 4 > 5 > 6 > 1 > 2
  ...
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>            # value is 1, skip traversal
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx                   # linked list start address
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx                  # node address for (7 - first input)
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax                  # node address for (7 - second input)
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi                  # linked list end address
  4011ba:	48 89 d9             	mov    %rbx,%rcx
  4011bd:	48 8b 10             	mov    (%rax),%rdx                      # link nodes in order, forming reversed list: 4 -> 3 -> 2 -> 1 -> 6 -> 5
  ...
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)                   # set last node's next pointer to null
  4011d9:	00 
...
0000000000401204 <fun7>:
  ...
  40120b:	74 2b                	je     401238 <fun7+0x34>               # input value must exist in the binary tree
  40120d:	8b 17                	mov    (%rdi),%edx
  40120f:	39 f2                	cmp    %esi,%edx
  401211:	7e 0d                	jle    401220 <fun7+0x1c>               # input value greater than node value
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi                   
  401217:	e8 e8 ff ff ff       	callq  401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax                        # third recursion step (eax = 2 here; final target is 2)
  40121e:	eb 1d                	jmp    40123d <fun7+0x39>
  401220:	b8 00 00 00 00       	mov    $0x0,%eax                        # first recursion step: node value equals input, set eax to 0
  401225:	39 f2                	cmp    %esi,%edx
  401227:	74 14                	je     40123d <fun7+0x39>
  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi
  40122d:	e8 d2 ff ff ff       	callq  401204 <fun7>
  401232:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax            # second recursion step (eax = 1 here; final target is 2)
...
0000000000401242 <secret_phase>:
  ...
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi                   # binary tree root address; struct: (long int, left child addr, right child addr)
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>
  401278:	83 f8 02             	cmp    $0x2,%eax
  40127b:	74 05                	je     401282 <secret_phase+0x40>       # fun7 must return 2
...
000000000040145c <read_six_numbers>:
  ...
  401460:	48 89 f2             	mov    %rsi,%rdx                       # third argument: address to store first integer   %rdx
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx                  # fourth argument: address to store second integer   %rcx
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax                 # eighth argument: address to store sixth integer
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)                  # push eighth argument onto stack                    0x8(%rsp)
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax                 # seventh argument: address to store fifth integer
  401474:	48 89 04 24          	mov    %rax,(%rsp)                     # push seventh argument onto stack                    (%rsp)
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9                   # sixth argument: address to store fourth integer    %r9
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8                   # fifth argument: address to store third integer    %r8
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi                  # second argument: format string address "%d %d"  %rsi
  401485:	b8 00 00 00 00       	mov    $0x0,%eax
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  40148f:	83 f8 05             	cmp    $0x5,%eax
  401492:	7f 05                	jg     401499 <read_six_numbers+0x3d>  # number of integers read must be greater than 5
